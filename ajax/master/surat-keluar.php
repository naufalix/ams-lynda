...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH'])
    ...
    if (isLoggedIn()) {
        $table = 'surat_keluar';
        $cols  = 'id, nomor_surat, tanggal_surat, tujuan, perihal, lampiran';
        ...
        foreach ($stmt as $row) {
            ...
            $nestedData[] = '
                <a class="btn green waves-effect waves-light" title="Lihat detail" href="?page=sk&act=show&id=' . $row->id . '"><i class="material-icons">list</i></a>

                <a class="btn blue waves-effect waves-light" title="Edit" href="?page=sk&act=edit&id=' . $row->id . '"><i class="material-icons">edit</i></a>

                <a class="btn deep-orange waves-effect waves-light" title="Hapus" href="?page=sk&act=del&id=' . $row->id . '"><i class="material-icons">delete</i></a>';
